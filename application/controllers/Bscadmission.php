 ...
 * 
 */
class Bscadmission extends CI_Controller
{
	
	function __construct()
	{
		parent::__construct();
		$this->load->model('bscadmissionm');
	}

	public function index()
	{
		$this->load->view('admin/bscadmission');
	...
	public function bscformvalidation()
	{
		...
		if ($this->form_validation->run()) {
			...
			$this->bscadmissionm->addstudent($data);
		} else {
			
		}
	}
	public function bscstudent()
	{
		$this->load->view('admin/bscstudent');
	}
	public function searchstudent()
	{
		...
		if ($this->form_validation->run()) {
			...
			$search["students"] = $this->bscadmissionm->searchstudent($data);
			$this->load->view('admin/bscstudent',$search);
		} else {
			$this->load->view('admin/bscstudent');
		}
	}
